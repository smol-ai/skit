...
import type { PortableBinding } from "../portable-contracts.js";

/** Retire owned global Projections whose portable Binding has disappeared. Caller owns the writer lock. */
export const retirePortableUnboundGlobalProjectionsEffect = Effect.fn(
  "Library.retirePortableUnboundGlobalProjections",
