/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.example.jsonc` (hash: b662f1bd28966492860cfe12dd95d612)
// Runtime types generated with workerd@1.20260820.1 2026-08-24 nodejs_compat
interface __BaseEnv_Env {
	SKIT_BLOBS: R2Bucket;
	DB: D1Database;
	AUTH_RATE_LIMITER: RateLimit;
	PAT_RATE_LIMITER: RateLimit;
	BOOTSTRAP_RATE_LIMITER: RateLimit;
	ASSETS: Fetcher;
	ACCOUNT_REGISTRATION_MODE: "closed";
	PUBLIC_APP_ORIGIN: "https://registry.example.com";
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ACCOUNT_REGISTRATION_MODE" | "PUBLIC_APP_ORIGIN">> {}
}
