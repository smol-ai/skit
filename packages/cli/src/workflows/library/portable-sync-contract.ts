...
const PortableSyncPlan = Schema.Struct({
  local: Schema.Array(PortableSyncChange),
  remote: Schema.Array(PortableSyncChange),
});
...
export const PortableSyncResult = Schema.Struct({
  ...
  plan: Schema.optionalKey(PortableSyncPlan),
});
export type PortableSyncResult = typeof PortableSyncResult.Type;
